...
class CacheActivationsRunnerConfig:
    ...
    ace_step_guidance_interval: int = 1.0
    ace_step_guidance_interval_decay: float = 0.0
    ace_step_guidance_scale_text: float = 0.0
    ace_step_guidance_scale_lyric: float = 0.0
